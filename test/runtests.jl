...
@testset "Radiomics test" begin
    ...
    @test isapprox(radiomic_features["firstorder_skewness"], 1.4563062464016754; rtol=3e-4)
    @test isapprox(radiomic_features["firstorder_mean_absolute_deviation"], 37.994561441034435; rtol=1e-4)
    ...
    @test isapprox(radiomic_features["firstorder_variance"], 2656.0167232488784; rtol=1e-4)
    @test isapprox(radiomic_features["firstorder_percentile10"], -904.0f0; atol=1e-4)
    @test isapprox(radiomic_features["firstorder_robust_mean_absolute_deviation"], 23.386925661021586; rtol=3e-4)
    @test isapprox(radiomic_features["firstorder_kurtosis"], 5.392519177048927; rtol=1e-4)
    ...
    @test isapprox(radiomic_features["glcm_Idmn"], 0.9764568, atol=1e-4)
    @test isapprox(radiomic_features["glcm_Idn"], 0.9103747, atol=1e-4)
    ...
    @test isapprox(radiomic_features["shape3d_maximum_3d_diameter"], 344.5685708244442; atol=0.04)
    ...
    @test isapprox(radiomic_features["shape3d_voxel_volume"], 5.88650625e6; atol=0.01)
