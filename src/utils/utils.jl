...
"""
    Function to process 2D slices.
        # Parameters:
        - `slices_2d`: The list of 2D slices to process.
        - `img_input`: The input image (Array).
        - `mask_input`: The mask defining the region of interest (Array).
        - `voxel_spacing_input`: The spacing of the voxels in the image (Array).
        ...
        - `verbose`: If true, prints progress messages.
        # Returns:
        - A tuple containing the results for each 2D slice."""
function process_slices_2d(slices_2d, img_input, mask_input, voxel_spacing_input;
                            features, labels, n_bins, bin_width, weighting_norm,
                            keep_largest_only, sample_rate, get_raw_matrices, verbose)
